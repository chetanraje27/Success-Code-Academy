...
## Corpus Check
- 246 files · ~3,728,974 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 1310 nodes · 2127 edges · 172 communities (124 shown, 48 thin omitted)
- Extraction: 100% EXTRACTED · 0% INFERRED · 0% AMBIGUOUS · INFERRED: 6 edges (avg confidence: 0.7)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `68e4d1d2`
...
- `AdminStudentsPage()` --calls--> `adminApiFetch()`  [EXTRACTED]
  client/src/app/admin/database/students/page.tsx → client/src/lib/admin-api.ts
...
### Community 2 - "app.ts"
Cohesion: 0.27
Nodes (6): app, errorHandler(), isZodError(), notFound(), requestLogger(), AppError
...
Cohesion: 0.10
Nodes (17): AdmissionsClient(), metadata, ContactClient(), generateCaptcha(), INITIAL_CAPTCHA, Op, metadata, metadata (+9 more)
...
Cohesion: 0.13
Nodes (18): getHealth, adminLoginLimiter, defaultLimiter, submissionLimiter, validate(), ValidationTarget, router, router (+10 more)
...
Cohesion: 0.18
Nodes (14): AdminCoursesPage(), ContactMessageEditorModal(), AdminContactMessagesPage(), CourseFormEditorModal(), AdminCourseFormsPage(), AdminScholarshipFormsPage(), ScholarshipFormEditorModal(), AdminPageBannersPage() (+6 more)
...
Cohesion: 0.24
Nodes (8): initNewsArticle(), NewsArticle, NewsArticleAttributes, NewsArticleCreationAttributes, router, isTransientDatabaseError(), readFromDatabase(), TRANSIENT_DATABASE_ERRORS

### Community 48 - "AdminLeadTable.tsx"
Cohesion: 0.15
Nodes (17): AdminStudentsPage(), AdminDashboardPage(), DashboardStats, quickActions, RecentStudent, TokenState, AdminLeadTable(), csvCell() (+9 more)
...
Cohesion: 0.17
Nodes (17): StudentEditorModal(), AdminModal(), Banner, BannerEditor(), BannerEditorProps, useEditMode(), Result, ResultEditor() (+9 more)
...
Cohesion: 0.23
Nodes (10): Course, initCourse(), CourseRegistration, CourseRegistrationAttributes, CourseRegistrationCreationAttributes, initCourseRegistration(), initNotification(), Notification (+2 more)

### Community 53 - "test-render.js"
Cohesion: 0.40
Nodes (4): data, https, options, req

### Community 55 - "recordMediaRevision"
Cohesion: 0.18
...
Cohesion: 0.24
Nodes (7): AdminSettingsPage(), initialSettings, SiteSettings, AdminLoadingState(), SettingsEditor(), AdminApiError, defaultSiteSettings

### Community 63 - "assertNotLastSuperAdmin"
Cohesion: 0.29
...
Cohesion: 0.25
Nodes (10): metadata, EditModeContext, EditModeContextValue, EditModeProvider(), useEditModeOptional(), useLiveContent(), LiveEditorToolbar(), pageName() (+2 more)
...
- **Why does `adminApiFetch()` connect `adminApiFetch` to `lib/roles.ts`, `api.ts`, `AdminLeadTable.tsx`, `EditableText.tsx`, `AdminModal.tsx`, `AdminContentManager.tsx`, `SettingsEditor.tsx`?**
