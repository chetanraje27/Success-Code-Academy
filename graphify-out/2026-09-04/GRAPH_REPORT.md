...
## Corpus Check
- 262 files · ~3,748,193 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 1415 nodes · 2453 edges · 197 communities (136 shown, 61 thin omitted)
- Extraction: 100% EXTRACTED · 0% INFERRED · 0% AMBIGUOUS · INFERRED: 6 edges (avg confidence: 0.7)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `7f3ad3f0`
...
## Communities (197 total, 61 thin omitted)
...
Cohesion: 0.15
Nodes (13): Footer(), Course, courses, NavLink, navLinks, NewsItem, newsItems, overviewFeatures (+5 more)
...
Cohesion: 0.17
Nodes (19): AdminCoursesPage(), AdminScholarshipProgramsPage(), ScholarshipProgramEditor(), ContactMessageEditorModal(), AdminContactMessagesPage(), CourseFormEditorModal(), AdminCourseFormsPage(), AdminScholarshipFormsPage() (+11 more)

### Community 12 - "authenticate.ts"
Cohesion: 0.33
Nodes (4): getHealth, router, asyncHandler(), AsyncRouteHandler
...
Cohesion: 0.15
Nodes (19): AdminLayout(), AdminTheme, allNavItems, navigation, NavItem, SessionState, AdminLoginPage(), LoginFailure (+11 more)
...
### Community 16 - "LiveContentContext.tsx"
Cohesion: 0.24
Nodes (9): ContentKind, ContentMap, ContentOverride, ContentScope, fetchContentMap(), LiveContentContext, LiveContentContextValue, LiveContentProvider() (+1 more)
...
Cohesion: 0.12
Nodes (15): Course, courseStyles, ExploreCourses(), Announcement, HomeBanner, HomeClient(), PublicContentResponse, renderAnnouncementIcon() (+7 more)
...
Cohesion: 0.09
Nodes (22): AdminNotificationsPage(), ICON_PRESETS, renderNotificationIcon(), AdminContentColumn, AdminContentField, AdminContentManager(), FieldValue, initialValues() (+14 more)
...
### Community 22 - "app.ts"
Cohesion: 0.21
Nodes (8): app, configuredOrigins, corsOptions, defaultAllowedOrigins, notFound(), requestLogger(), router, v1Router
...
Cohesion: 0.18
Nodes (18): main(), Env, envSchema, parsed, reconcileSchema(), scheduleDatabaseReconnect(), startServer(), errorHandler() (+10 more)

### Community 31 - "models/index.ts"
Cohesion: 0.13
Nodes (18): dbConfig, ContactMessage, ContactMessageAttributes, ContactMessageCreationAttributes, initContactMessage(), Course, initCourse(), initNewsletterSubscriber() (+10 more)
...
Cohesion: 0.17
Nodes (17): metadata, EditModeContext, EditModeContextValue, EditModeProvider(), useEditModeOptional(), useLiveContent(), LiveEditorToolbar(), pageName() (+9 more)
...
Cohesion: 0.16
Nodes (12): AdmissionsClient(), ContactClient(), generateCaptcha(), INITIAL_CAPTCHA, Op, metadata, EditableSection(), EditableSectionProps (+4 more)
...
Cohesion: 0.12
Nodes (18): createRegistration, getMyRegistration, updateMyRegistration, adminLoginLimiter, defaultLimiter, passwordResetLimiter, submissionLimiter, validate() (+10 more)
...
### Community 163 - "BannerEditor.tsx"
Cohesion: 0.14
Nodes (20): AdminPageBannersPage(), PAGE_SLOTS, PageBannerSlot, AdminEmptyState(), AdminLoadingState(), Banner, BannerEditor(), BannerEditorProps (+12 more)
...
### Community 184 - "Toast.tsx"
Cohesion: 0.11
Nodes (14): ResetPasswordForm(), TokenState, StudentSignupPage(), ICON_PRESETS, Notification, NotificationEditor(), NotificationEditorProps, renderIconByKey() (+6 more)

### Community 185 - "adminPasswordReset.ts"
Cohesion: 0.20
Nodes (15): appBaseUrl(), requestSelfPasswordReset, sendAdminPasswordReset, forgotAdminPassword, forgotUserPassword, requestAdminPasswordReset, buildResetUrl(), checkResetCooldown() (+7 more)
...
Cohesion: 0.29
Nodes (11): findExistingCourseRegistration(), getMyCourseRegistration, normaliseEmail(), normalisePhone(), submitContactForm, submitCourseRegistration, updateMyCourseRegistration, authenticate (+3 more)

### Community 188 - "lib/roles.ts"
Cohesion: 0.32
...
### Community 189 - "SettingsEditor.tsx"
Cohesion: 0.26
Nodes (8): AdminSettingsPage(), initialSettings, SiteSettings, useAdminSession(), AdminNotice(), AdminApiError, defaultSiteSettings, PublicSiteSettings

### Community 190 - "isAdminRole"
Cohesion: 0.35
Nodes (10): backendUrl(), DELETE(), GET(), isSameOrigin(), parseBackendResponse(), POST(), PUT(), LoginFailure (+2 more)

### Community 191 - "ToppersCarousel.tsx"
Cohesion: 0.38
...
### Community 195 - "17. Environment Variables Reference"
Cohesion: 0.67
Nodes (3): 17. Environment Variables Reference, Client (`client/.env.local`), Server (`server/.env`)

## Knowledge Gaps
- **577 isolated node(s):** `$schema`, `.opencode/plugins/graphify.js`, `eslintConfig`, `nextConfig`, `name` (+572 more)
...
- **Why does `adminApiFetch()` connect `adminApiFetch` to `admin/page.tsx`, `BannerEditor.tsx`, `LiveContentContext.tsx`, `AdminContentManager.tsx`, `ContactClient.tsx`, `api.ts`, `lib/roles.ts`, `SettingsEditor.tsx`?**
  _High betweenness centrality (0.014) - this node is a cross-community bridge._
- **Why does `useToast()` connect `adminApiFetch` to `BannerEditor.tsx`, `admin/layout.tsx`, `Toast.tsx`, `ContactClient.tsx`, `api.ts`, `lib/roles.ts`, `SettingsEditor.tsx`, `isAdminRole`?**
